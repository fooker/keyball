...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    KC_LCTL  , KC_LALT  , _______  , _______  , MO(2)    ,LT(1,KC_SPC),KC_BSPC  ,    LT(3,KC_TAB),LSFT_T(KC_ENT), XXXXXXX  , XXXXXXX  , XXXXXXX  , DE_SLSH  , KC_RCTL
  ),
  ...
  [1] = LAYOUT_universal(
    ...
    _______  , _______  , _______  , _______  , _______  , _______  , KC_DEL   ,            KC_INS   , KC_RSFT  , XXXXXXX  , XXXXXXX  , XXXXXXX  , DE_BSLS  , KC_CAPS
  ),
  ...
  [3] = LAYOUT_universal(
    ...
    _______  , _______  , _______  , KC_0     , KC_DOT   , KC_SPC   , KC_DEL   ,            _______  , KC_ENT   , XXXXXXX  , XXXXXXX  , XXXXXXX  , _______  , _______
  ),
